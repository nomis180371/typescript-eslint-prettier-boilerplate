...
const addDestinationPicture = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const file = req.file;
        const destinationRepository = index_1.AppDataSource.getRepository(destination_1.Destination);
        ...
        const destinationPictureRepository = index_1.AppDataSource.getRepository(destinationPicture_1.DestinationPicture);
